...
static struct clkctl_acpu_speed pll0_960_pll1_245_pll2_1200_pll4_800[] = {
	...
	{ 1, 800000, ACPU_PLL_4, 6, 0, 100000, 3, 6, 200000 }, 
   	...
   	{ 1, 800000, ACPU_PLL_4, 6, 0, 100000, 3, 7, 200000 },
    	...
    	{ 1, 900000, ACPU_PLL_2, 2, 3, 112500, 3, 7, 200000 },
	{ 1, 950000, ACPU_PLL_2, 2, 3, 118750, 3, 7, 200000 },
    	{ 1, 1000000, ACPU_PLL_2, 2, 3, 125000, 3, 7, 200000 },	
	#ifdef CONFIG_MSM7X27A_BACONMAKER
    	{ 1, 1050000, ACPU_PLL_2, 2, 3, 131250, 2, 7, 220000 },
    	{ 1, 1100000, ACPU_PLL_2, 2, 3, 137500, 2, 7, 220000 },
	#endif
	#endif
	{ 0 }
};
...
static struct clkctl_acpu_speed pll0_960_pll1_245_pll2_1200_pll4_1008[] = {
	...
	{ 1, 1267200, ACPU_PLL_2, 2, 3, 158400, 3, 7, 200000 },
    	{ 1, 1300000, ACPU_PLL_2, 2, 3, 162500, 3, 7, 200000 },
	#endif
	#endif
	{ 0 }
};
